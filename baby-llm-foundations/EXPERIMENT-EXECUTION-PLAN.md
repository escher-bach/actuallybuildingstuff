...
This document is the sole implementation and operations contract for Step 1
Kaggle runs. It governs launch, monitoring, retention, retrieval, and audit. It
...
The immediate scientific comparison remains:
...
The existing Step 1 gates remain authoritative:
...
All CPU benchmark results are retained even when a gate fails. A failed gate
blocks the main scientific run but is itself a useful engineering result.
