...
> **Closure status, 2026-08-20:** STEP 1 is closed as the failed scientific
> design `world-0.1.0`. The authoritative diagnosis is
> [STEP-1-EXPERIMENT-DESIGN-FAILURE.md](STEP-1-EXPERIMENT-DESIGN-FAILURE.md),
> and the preservation and transfer boundary is
> [STEP-1-WORLD-0.1-CLOSURE.md](STEP-1-WORLD-0.1-CLOSURE.md). Recorded metrics
> remain factual, but no intended process-learning or process-transfer claim
> survives. Do not patch and rerun this family.
...
> **Superseded pre-audit status, 2026-08-17:** STEP 1 is complete as an internal
...
- at least one probe changes the set of hypotheses consistent with the
  history;
- the true hypothesis can be identified withian the budget;
...
> **Closure amendment (2026-08-20).** The above completion interpretation is
> superseded by [STEP-1-EXPERIMENT-DESIGN-FAILURE.md](STEP-1-EXPERIMENT-DESIGN-FAILURE.md)
> and [STEP-1-WORLD-0.1-CLOSURE.md](STEP-1-WORLD-0.1-CLOSURE.md). The deployed
> `world-0.1.0` family fails the information-boundary audit: privileged teacher
> targets and the 97.7% comparator are not functions of learner-visible
> information, and the sampler exposes a stable-label shortcut. Recorded metrics
> remain factual for this family but cannot establish intended process learning,
> learner-followable demonstration, or reusable transfer. STEP 1 is **closed as
> an invalid scientific world design**; preserve its code, artifacts, and
> operational lessons, but do not patch and rerun it. A future Step 2 begins
> only after a separate validity-contract and world-operator specification.

#### Superseded pre-audit completion rationale

The target-shuffled control, rendering-transfer stage, and outcome-only stage
were previously read as making the required distinction. Dense traces produced state-dependent
