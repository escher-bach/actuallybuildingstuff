...
The maintained-stack ownership boundary remains reusable after world-0.1
closure. It does not preserve or revive that world's generator, teacher, or
scientific claims; their disposition is recorded in
...
synthetic capability-gate portions of `EXPERIMENT-EXECUTION-PLAN.md`. The
world-0.1 teacher, rendering, data-provenance, and scientific comparison
specifications remain historical records rather than a contract for the next
world.
